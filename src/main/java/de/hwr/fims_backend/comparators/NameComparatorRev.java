...
/**	Zweck: Diese Klasse dient dem Sortieren des Auftragsarrays in der Auftragsverwaltung nach dem Namen der
 * 		   Verstorbenen Person in r�ckw�rtiger alphabetischer Reihenfolge. 
 *  @autor: Rebecca Held
 *  @version: 1.0
...
public class NameComparatorRev implements Comparator<Auftrag>{
